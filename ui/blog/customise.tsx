...
import { ImageComponent, CodeBlock } from ".";
...
export const CustomPortableTextComponents: PortableTextComponents = {
  ...
  block: {
    ...
    blockquote: ({ children }) => <div className="border-l-4 border-olivine-dark dark:border-olivine bg-porcelain-dark dark:bg-steel-grey px-4 py-2 my-4 rounded-md">{children}</div>,
  },
  list: {
