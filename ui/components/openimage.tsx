...
export function OpenImage({ caption, onClick, alt, style, ...props }: OpenImageProps) {
...
export function OpenTextImage({ caption, children, alt, style, ...props }: OpenTextImageProps) {
	const [open, setOpen] = useState(false);
