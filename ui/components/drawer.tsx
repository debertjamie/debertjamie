...
>(({className, children, ...props}, ref) => (
  <DrawerPortal>
    ...
    <DrawerPrimitive.Content
      ref={ref}
      className={`fixed bg-zinc-200 dark:bg-zinc-800 inset-x-0 bottom-0 z-50 mt-24 flex h-auto flex-col rounded-t-[10px] border-2 border-zinc-800 dark:border-zinc-200 ${className}`}
      {...props}
    >
